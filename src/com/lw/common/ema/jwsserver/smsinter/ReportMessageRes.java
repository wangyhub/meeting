...
public class ReportMessageRes  implements java.io.Serializable {
    private com.lw.common.ema.jwsserver.smsinter.ReportMessageResDetail[] resDetail;
    ...
    public ReportMessageRes(
           com.lw.common.ema.jwsserver.smsinter.ReportMessageResDetail[] resDetail,
     ...
     * @return resDetail
     */
    public com.lw.common.ema.jwsserver.smsinter.ReportMessageResDetail[] getResDetail() {
        return resDetail;
    }
     ...
     * @param resDetail
     */
    public void setResDetail(com.lw.common.ema.jwsserver.smsinter.ReportMessageResDetail[] resDetail) {
        this.resDetail = resDetail;
    }

    public com.lw.common.ema.jwsserver.smsinter.ReportMessageResDetail getResDetail(int i) {
        return this.resDetail[i];
    }

    public void setResDetail(int i, com.lw.common.ema.jwsserver.smsinter.ReportMessageResDetail _value) {
