...
(function($) {
	...
	$.fn.seatCharts = function (setup) {
		...
		$.each(settings.map, function(row, characters) {
			 ...
			 * a[,LABEL]
			 *
			 * Allowed characters in IDs areL 0-9, a-z, A-Z, =
			 * Allowed characters in labels are: 0-9, a-z, A-Z, =, ' ' (space)
			 *
			 */
			 
			$.each(characters.match(/[a-z=]{1}(\[[0-9a-z=]{0,}(,[0-9a-z= ]+)?\])?/gi), function (column, characterParams) { 
				var matches         = characterParams.match(/([a-z=]{1})(\[([0-9a-z= ,]+)\])?/i),
